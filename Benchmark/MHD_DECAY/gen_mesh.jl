# Benchmark/MHD_DECAY/gen_mesh.jl — Generate uniform Cartesian mesh for decaying MHD turbulence
# Usage: julia Benchmark/MHD_DECAY/gen_mesh.jl [Nx] [Ny] [Nz]
# Output: Benchmark/MHD_DECAY/MESH/ directory with mesh, metrics, connectivity files
#
...
println("Generating MHD-decay mesh: $(Nx)×$(Ny)×$(Nz) (uniform, triply periodic)")
...
println("✓ MHD-decay mesh saved to $(out_dir)/")

# Benchmark/ORSZAG_TANG_3D/gen_mesh.jl — Generate uniform Cartesian mesh for 3D Orszag-Tang
# Usage: julia Benchmark/ORSZAG_TANG_3D/gen_mesh.jl [Nx] [Ny] [Nz]
# Output: Benchmark/ORSZAG_TANG_3D/MESH/ directory with mesh, metrics, connectivity files
#
# Domain: [0, 2π]³, uniform Cartesian, single block, triply periodic.
# Classic MHD turbulence + shock-interaction benchmark (3D extension).
...
println("Generating 3D Orszag-Tang mesh: $(Nx)×$(Ny)×$(Nz) (uniform, triply periodic)")
...
println("✓ 3D Orszag-Tang mesh saved to $(out_dir)/")

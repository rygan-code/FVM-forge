...
# flow control
const test_case::String = "Sod" # "TGV" or "ObliqueShock" or "Sod" or "FlatPlate"
const mesh::String = "Benchmark/SOD/sod_mesh.h5"
const metrics::String = "Benchmark/SOD/sod_metrics.h5"
...
const CFL::FT = FT(0.1)             #   CFL number
...
const maxStep::Int64 = 2000           # Max steps for benchmark

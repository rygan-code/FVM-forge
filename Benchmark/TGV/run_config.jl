...
# flow control
const test_case::String = "TGV" # "TGV" or "ObliqueShock" or "Sod" or "FlatPlate"
const mesh::String = "Benchmark/TGV/tgv_mesh.h5"
const metrics::String = "Benchmark/TGV/tgv_metrics.h5"
const Nprocs::SVector{3, Int64} = [1,1,1] # number of GPUs
const Iperiodic = (true, true, true)   # periodic direction
...
const dt::FT = 4e-4             # Fixed dt (used when adaptive_dt=false)
const Time::FT = 0.2             # Total simulation time
const maxStep::Int64 = 1000           # Max steps for benchmark
...
const hybrid_ϕ1::FT = FT(5e-2)          # < ϕ1: Linear

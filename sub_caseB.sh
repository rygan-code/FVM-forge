...
#SBATCH -p kshdnormal
#SBATCH -t 48:00:00
#SBATCH -o tmp_runs/caseB.out
#SBATCH -e tmp_runs/caseB.err
...
WORK="$ROOT/tmp_runs/caseB_uniform"
...
mpirun -np 24 julia run_pipe_caseB.jl --mesh_dir=MESH_LEN15 500000

...
#SBATCH -p kshdnormal
#SBATCH -t 48:00:00
#SBATCH -o tmp_runs/caseC.out
#SBATCH -e tmp_runs/caseC.err
...
WORK="$ROOT/tmp_runs/caseC_norot"
...
mpirun -np 24 julia run_pipe_caseC.jl --mesh_dir=MESH_LEN15 500000
